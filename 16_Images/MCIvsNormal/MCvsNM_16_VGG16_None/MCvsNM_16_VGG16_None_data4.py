...
def save_bottlebeck_features():
	...
	model = applications.VGG16(weights=None, include_top=True, input_shape=(224, 224, 3))
	print('Model loaded.')
...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('MCvsNM_16_VGG16_None_Data4 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_16_VGG16_None_Data4_loss.png')
	plt.close()
        ...
        plt.title('MCvsNM_16_VGG16_None_Data4 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_16_VGG16_None_Data4_acc.png')
	plt.close()
