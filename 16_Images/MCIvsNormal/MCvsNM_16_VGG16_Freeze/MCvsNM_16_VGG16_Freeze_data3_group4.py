...
#            loss='sparse_categorical_crossentropy', metrics=['accuracy'])
        ...
        plt.title('MCvsNM_16_VGG16_Freeze_data3_group4 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_16_VGG16_Freeze_data3_group4_loss.png')
	plt.close()
        ...
        plt.title('MCvsNM_16_VGG16_Freeze_data3_group4 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_16_VGG16_Freeze_data3_group4_acc.png')
	plt.close()
