...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('Freeze Group 2 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('VGG16_Freeze_Group2_loss.png')
	plt.close()
        ...
        plt.title('Freeze Group 2 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('VGG16_Freeze_Group2_acc.png')
	plt.close()
