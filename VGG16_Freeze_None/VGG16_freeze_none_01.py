...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('Freeze Group 1 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        plt.show()
	plt.savefig('VGG16_Freeze_Group1_loss.png')
	plt.close()
        ...
        plt.title('Freeze Group 1 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        plt.show()
	plt.savefig('VGG16_Freeze_Group1_acc.png')
	plt.close()
