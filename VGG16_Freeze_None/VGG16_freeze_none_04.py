...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('Freeze Group 4 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('VGG16_Freeze_Group4_loss.png')
	plt.close()
        ...
        plt.title('Freeze Group 4 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('VGG16_Freeze_Group4_acc.png')
	plt.close()
