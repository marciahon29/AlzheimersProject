...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('Freeze Group 0 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        plt.show()
	plt.savefig('VGG16_Freeze_Group0_loss.png')
	plt.close()
        ...
        plt.title('Freeze Group 0 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        plt.show()
	plt.savefig('VGG16_Freeze_Group0_acc.png')
	plt.close()
