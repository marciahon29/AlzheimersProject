...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('InceptionV3_ImageNet_500Epochs - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('InceptionV3_ImageNet_500Epochs_loss.png')
	plt.close()
        ...
        plt.title('InceptionV3_ImageNet_500Epochs - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('InceptionV3_ImageNet_500Epochs_acc.png')
	plt.close()
