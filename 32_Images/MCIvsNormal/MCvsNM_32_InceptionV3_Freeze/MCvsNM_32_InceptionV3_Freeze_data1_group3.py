...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('MCvsNM_32_InceptionV3_Freeze_data1_group3 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_32_InceptionV3_Freeze_data1_group3_loss.png')
	plt.close()
        ...
        plt.title('MCvsNM_32_InceptionV3_Freeze_data1_group3 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_32_InceptionV3_Freeze_data1_group3_acc.png')
	plt.close()
