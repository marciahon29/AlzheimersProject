...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('MCvsNM_32_VGG16_Freeze_data3_group3 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_32_VGG16_Freeze_data3_group3_loss.png')
	plt.close()
        ...
        plt.title('MCvsNM_32_VGG16_Freeze_data3_group3 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_32_VGG16_Freeze_data3_group3_acc.png')
	plt.close()
