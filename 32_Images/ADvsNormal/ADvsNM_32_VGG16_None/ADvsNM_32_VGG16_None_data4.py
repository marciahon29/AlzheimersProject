...
def save_bottlebeck_features():
	...
	vgg_model = applications.VGG16(weights=None, include_top=False, input_shape=(150, 150, 3))
	print('Model loaded.')
...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('ADvsNM_32_VGG16_None_Data4 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsNM_32_VGG16_None_Data4_loss.png')
	plt.close()
        ...
        plt.title('ADvsNM_32_VGG16_None_Data4 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsNM_32_VGG16_None_Data4_acc.png')
	plt.close()
