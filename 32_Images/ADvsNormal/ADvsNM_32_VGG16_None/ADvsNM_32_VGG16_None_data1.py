...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('ADvsNM_32_VGG16_None_Data1 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsNM_32_VGG16_None_Data1_loss.png')
	plt.close()
        ...
        plt.title('ADvsNM_32_VGG16_None_Data1 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsNM_32_VGG16_None_Data1_acc.png')
	plt.close()
