...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('ADvsNM_32_VGG16_Freeze_data2_group4 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsNM_32_VGG16_Freeze_data2_group4_loss.png')
	plt.close()
        ...
        plt.title('ADvsNM_32_VGG16_Freeze_data2_group4 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsNM_32_VGG16_Freeze_data2_group4_acc.png')
	plt.close()
