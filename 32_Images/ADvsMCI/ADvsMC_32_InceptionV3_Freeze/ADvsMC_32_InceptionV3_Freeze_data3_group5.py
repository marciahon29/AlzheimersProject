...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('ADvsMC_32_InceptionV3_Freeze_data3_group5 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_32_InceptionV3_Freeze_data3_group5_loss.png')
	plt.close()
        ...
        plt.title('ADvsMC_32_InceptionV3_Freeze_data3_group5 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_32_InceptionV3_Freeze_data3_group5_acc.png')
	plt.close()
