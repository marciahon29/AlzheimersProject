...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('ADvsMC_32_InceptionV3_Freeze_data0_group0 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_32_InceptionV3_Freeze_data0_group0_loss.png')
	plt.close()
        ...
        plt.title('ADvsMC_32_InceptionV3_Freeze_data0_group0 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_32_InceptionV3_Freeze_data0_group0_acc.png')
	plt.close()
