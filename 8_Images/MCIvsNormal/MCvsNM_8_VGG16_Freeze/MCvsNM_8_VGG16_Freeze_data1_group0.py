...
#            loss='sparse_categorical_crossentropy', metrics=['accuracy'])
        ...
        plt.title('MCvsNM_8_VGG16_Freeze_data1_group0 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_8_VGG16_Freeze_data1_group0_loss.png')
	plt.close()
        ...
        plt.title('MCvsNM_8_VGG16_Freeze_data1_group0 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('MCvsNM_8_VGG16_Freeze_data1_group0_acc.png')
	plt.close()
