...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('ADvsNM_64_VGG16_Freeze_data3_group5 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsNM_64_VGG16_Freeze_data3_group5_loss.png')
	plt.close()
        ...
        plt.title('ADvsNM_64_VGG16_Freeze_data3_group5 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsNM_64_VGG16_Freeze_data3_group5_acc.png')
	plt.close()
