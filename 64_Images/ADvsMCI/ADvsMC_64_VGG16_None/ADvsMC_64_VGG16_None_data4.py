...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('ADvsMC_64_VGG16_None_Data4 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_64_VGG16_None_Data4_loss.png')
	plt.close()
        ...
        plt.title('ADvsMC_64_VGG16_None_Data4 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_64_VGG16_None_Data4_acc.png')
	plt.close()
