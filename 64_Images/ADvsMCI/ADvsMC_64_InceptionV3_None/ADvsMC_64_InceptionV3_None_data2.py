...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('ADvsMC_64_InceptionV3_None_Data2 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_64_InceptionV3_None_Data2_loss.png')
	plt.close()
        ...
        plt.title('ADvsMC_64_InceptionV3_None_Data2 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_64_InceptionV3_None_Data2_acc.png')
	plt.close()
