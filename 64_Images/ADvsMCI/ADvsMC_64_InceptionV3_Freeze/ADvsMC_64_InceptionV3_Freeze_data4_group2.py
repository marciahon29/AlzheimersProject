...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('ADvsMC_64_InceptionV3_Freeze_data4_group2 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_64_InceptionV3_Freeze_data4_group2_loss.png')
	plt.close()
        ...
        plt.title('ADvsMC_64_InceptionV3_Freeze_data4_group2 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('ADvsMC_64_InceptionV3_Freeze_data4_group2_acc.png')
	plt.close()
