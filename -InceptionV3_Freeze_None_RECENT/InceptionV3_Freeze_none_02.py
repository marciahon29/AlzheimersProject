...
def save_bottlebeck_features():
	...
	model = applications.InceptionV3(weights=None, include_top=True, input_shape=(150, 150, 3))
	print('Model loaded.')
	...
	# always keep classification layers trainable
        #layer_count = 1
        for layer in model.layers[0:124]:
...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('InceptionV3 Freeze None Group 2 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('InceptionV3_Freeze_none_02_loss.png')
	plt.close()
        ...
        plt.title('InceptionV3 Freeze None Group 2 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('InceptionV3_Freeze_none_02_acc.png')
	plt.close()
