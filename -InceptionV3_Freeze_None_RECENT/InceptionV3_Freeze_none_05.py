...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('InceptionV3 Freeze None Group 5 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('InceptionV3_Freeze_none_05_loss.png')
	plt.close()
        ...
        plt.title('InceptionV3 Freeze None Group 5 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('InceptionV3_Freeze_none_05_acc.png')
	plt.close()
