...
def save_bottlebeck_features():
	...
	# always keep classification layers trainable
        #layer_count = 1
        for layer in model.layers[0:248]:
...
#            loss='binary_crossentropy', metrics=['accuracy'])
        ...
        plt.title('InceptionV3 Freeze None Group 4 - Training and validation loss')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('InceptionV3_Freeze_none_04_loss.png')
	plt.close()
        ...
        plt.title('InceptionV3 Freeze None Group 4 - Training and validation accuracy')
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        #plt.show()
	plt.savefig('InceptionV3_Freeze_none_04_acc.png')
	plt.close()
